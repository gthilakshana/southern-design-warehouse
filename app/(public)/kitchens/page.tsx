...
export default async function KitchensPage() {
  ...
  const contentImage = content?.contentUrl || "/images/warehouse1.webp";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
      {[
        ...
        { 
          ...
          image: '/kitchens/Coutertops.webp'
        },
        { 
...
<section className="py-28 px-6 md:px-12 lg:px-24 bg-[#fcfcfc]">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        { label: 'Cabinetry', count: '500+ Products', image: '/kitchens/Cabinetry.webp' },
        { label: 'Countertops', count: '320+ Products', image: '/kitchens/Coutertops.webp' },
        { label: 'Backsplash Tiles', count: '280+ Products', image: '/kitchens/Tiles.webp' },
        { label: 'Flooring', count: '350+ Products', image: '/kitchens/Flooring.webp' },
        { label: 'Lighting Fixtures', count: '220+ Products', image: '/kitchens/Light.webp' },
        { label: 'Sinks & Faucets', count: '280+ Products', image: '/kitchens/sinks.webp' },
        { label: 'Paint & Finishes', count: '180+ Products', image: '/kitchens/paint.webp' },
        { label: 'Hardware & Accessories', count: '420+ Products', image: '/kitchens/hardware.webp' }
      ].map((category, index) => (
        <button 
          key={index} 
